...
public class Device {
  ...
  public int MouseMovedIgnore = 0;
  public int MouseMovedShow = 1;
  public int MouseMovedPause = 2;
  public int MouseMovedAction = 3;
  public int mouseMovedResponse = MouseMovedIgnore;
